...
// "percent explored" and a fill colour. Pure static data — types live in ../types, selector helpers in ../utils/selectors.
 ...
 */
export const POI_CITY_ID: Record<string, string> = {
  // Zagreb
